  ...
  const VOICE_REGISTERS = {
    ...
    direct: {
      ...
      affection: {
        ...
        low:       ['guarded', 'careful', 'held back', 'measured', 'cool', 'careful', 'reserved', 'wary', 'tentative', 'cautious', 'slow to open', 'not warm', 'pulled back', 'half-closed', 'minimal', 'tight', 'low warmth', 'not ready', 'arms crossed', 'not free'],
